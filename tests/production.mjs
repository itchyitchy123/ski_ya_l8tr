...
const assets=['styles.css?v=51','modern.css?v=4','pro-systems.js?v=4','replay.js?v=5','systems/events.js?v=1','systems/audio.js?v=1','systems/input.js?v=1','systems/ui-state.js?v=1','game.js?v=118','performance.js?v=1','mobile.js?v=3'];
...
if(!sw.includes("./game.js?v=118"))throw new Error('Service worker is not caching the current game build');
for(const token of ['function drawDownhillSkiTips','function drawRearRiderDetails','drawSkier=drawDownhillSkier'])if(!game.includes(token))throw new Error(`Missing downhill rider orientation guard: ${token}`);
