...
const requiredIds=['gameCanvas','runSelect','modeSelect','settingsDialog','contrastSetting','sensitivitySetting','hapticsSetting','tutorialDialog','boostButton','tiltButton','trailPreview','runProgressFill','shareButton','playReplayButton'];
